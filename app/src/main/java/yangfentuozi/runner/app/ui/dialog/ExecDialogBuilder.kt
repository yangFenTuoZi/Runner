...
class ExecDialogBuilder(val mContext: Activity, val cmdInfo: CommandInfo, val waitServiceTimeout: Long = -1L) : BaseDialogBuilder(mContext) {
    var pid: Int = 0
    var h1: Thread? = null
    var h2: Thread? = null
    ...
    override fun show(): AlertDialog? {
        ...
        binding.execMsg.setOnKeyListener { view, i, keyEvent ->
            if (keyEvent.keyCode == KeyEvent.KEYCODE_ENTER && keyEvent.action == KeyEvent.ACTION_DOWN) alertDialog?.cancel()
            false
        }
