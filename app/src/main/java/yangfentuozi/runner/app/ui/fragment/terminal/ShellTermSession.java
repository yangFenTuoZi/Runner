...
public class ShellTermSession extends GenericTermSession {
    ...
    public ShellTermSession(String shell, String initialCommand) throws IOException {
        super(ParcelFileDescriptor.open(new File("/dev/ptmx"), ParcelFileDescriptor.MODE_READ_WRITE), false);

        initializeSession(shell);
    ...
    private void initializeSession(String shell) throws IOException {
        mProcId = createSubprocess(shell, null);
    }
