...
object ThemeUtil {
    ...
    private val isBlackNightTheme: Boolean
        get() = App.Companion.preferences.getBoolean("black_dark_theme", false)

    val isSystemAccent: Boolean
        get() = DynamicColors.isDynamicColorAvailable() && App.Companion.preferences.getBoolean(
    ...
    val colorTheme: String
        get() {
            ...
            return App.Companion.preferences.getString("theme_color", "COLOR_BLUE")!!
        }
    ...
    val darkTheme: Int
        get() = getDarkTheme(
            App.Companion.preferences.getString(
                "dark_theme",
